...
for filename in glob.glob("*.h5"):
	...
	snaps = list(density_group.keys())
	label = filename.replace('hdf5_1D_','').replace('.h5','')
	...
	fig_name = 'velocity_x_group' + label + snaps[-1] + '.png'
...
plt.legend(title='Velocity Profile')
